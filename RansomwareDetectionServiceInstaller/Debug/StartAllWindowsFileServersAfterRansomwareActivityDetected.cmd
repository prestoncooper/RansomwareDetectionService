...
REM sc \\[WINDOWS_FILE_SERVER_NAME] config Dfs start=auto
REM timeout 5
REM sc \\[WINDOWS_FILE_SERVER_NAME] config Browser start=demand
REM timeout 5
REM sc \\[WINDOWS_FILE_SERVER_NAME] config LanmanServer start=auto
REM timeout 10
